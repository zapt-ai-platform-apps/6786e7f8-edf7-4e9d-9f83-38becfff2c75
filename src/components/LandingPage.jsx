  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      <div className="max-w-2xl">
        <h1 className="text-2xl font-bold mb-4">Welcome to the BetterInvestor.net Global Investment Portfolio Designer!</h1>
        <p className="mb-4">
          BetterInvestor.net is an Investment Portfolio Designer that helps DIY investors by suggesting ideas for structuring a personalized investment portfolio comprising an optimal allocation of asset classes to suit their investment preferences and risk appetite.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          If you wish to continue, please confirm below that you understand that the BetterInvestor.net app does not provide financial advice and is intended purely for informational purposes only.
        </p>
